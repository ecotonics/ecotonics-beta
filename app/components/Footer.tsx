                        ...
                        <div className='md:mx-auto'>
                            <div>
                                ...
                                <ul className="space-y-2">
                                    <li><a href="#" className="text-lg md:text-lg hover:text-gray-500 transition">ABOUT US</a></li>
                                    <li><a href="#" className="text-lg md:text-lg hover:text-gray-500 transition">SOLUTIONS</a></li>
                                    <li><a href="#" className="text-lg md:text-lg hover:text-gray-500 transition">PROJECTS</a></li>
                                    <li><a href="#" className="text-lg md:text-lg hover:text-gray-500 transition">CONTACT</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className='md:mx-auto'>
                            <div>
                                ...
                                <div className="flex space-x-4 mt-4">
                                    <a href="#" className="hover:text-gray-500 transition"><Facebook size={22} /></a>
                                    <a href="#" className="hover:text-gray-500 transition"><Instagram size={22} /></a>
                                    <a href="#" className="hover:text-gray-500 transition"><Linkedin size={22} /></a>
                                </div>
                            </div>
                        </div>
                    </div>

                    <div className="text-center text-lg md:text-xl mt-10 border-t pt-6">
