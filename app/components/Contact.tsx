                ...
                <div className="px-5 py-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center min-h-[400px]">
                        ...
                        <form className="space-y-6 h-full">
                            ...
                            <button
                                type="submit"
                                className="text-sm bg-white text-black font-bold px-6 py-3 rounded-2xl hover:bg-gray-900 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-0.5"
                            >
                                SEND MESSAGE
                            </button>
                        </form>
